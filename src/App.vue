...
<v-app>
  ...
  <i class="fas fa-bars hidden-sm-and-up" @click.stop="sideNav = !sideNav"></i>
    <v-toolbar-title>
      <router-link to="/" tag="span" style="cursor: pointer">ElenaHrndz</router-link>
    </v-toolbar-title>
    <v-spacer></v-spacer>
...
.responsive-banner {
  ...
  border-radius: 10px;
  overflow: hidden;
  background-image: linear-gradient(to bottom right, #bbdcef, #41709c);
