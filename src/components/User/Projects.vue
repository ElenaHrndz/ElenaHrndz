<template lang="html">
  <div id="app">
      ...
      <transition-group class="projects" name="projects" >
        <div class="project" v-if="project.category.includes(currentFilter) || currentFilter === 'ALL'" v-bind:key="project.title" v-for="project in projects">
          ...
          <div class="">
            <p v-for="category in project.category">{{ category  }}</p>
