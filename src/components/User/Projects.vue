      ...
      <div class="title-container">
        <div>
  		...
  		<div class="filters">
  			...
  			<span class="filter" v-bind:class="{ active: currentFilter === 'DOODLES' }" v-on:click="setFilter('DOODLES')">DOODLES</span>
  		</div>
  	</div>
...
export default {
    ...
    return{
  		currentFilter: 'ALL',
  		projects: [
  			{title: "Encrypt", image: "/static/images/Encrypt.png", category: 'ART'},
